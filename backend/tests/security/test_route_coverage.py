...
EXPECTED: dict[tuple[str, str], str] = {
    ...
    # Enterprise organization (Phase 6.13-B).
    ("GET", "/api/v1/organizations"): ORG_READ,
    ("GET", "/api/v1/organizations/{organization_id}"): ORG_READ,
    ("GET", "/api/v1/organizations/{organization_id}/plants"): ORG_READ,
    ("GET", "/api/v1/plants/{plant_id}/areas"): ORG_READ,
    ("POST", "/api/v1/organizations"): ORG_MANAGE,
    ("POST", "/api/v1/organizations/{organization_id}/plants"): ORG_MANAGE,
    ("POST", "/api/v1/plants/{plant_id}/areas"): ORG_MANAGE,
    ("PATCH", "/api/v1/organizations/{organization_id}"): ORG_MANAGE,
    ("PATCH", "/api/v1/plants/{plant_id}"): ORG_MANAGE,
    ("PATCH", "/api/v1/areas/{area_id}"): ORG_MANAGE,
    ("DELETE", "/api/v1/organizations/{organization_id}"): ORG_MANAGE,
    ("DELETE", "/api/v1/plants/{plant_id}"): ORG_MANAGE,
    ("DELETE", "/api/v1/areas/{area_id}"): ORG_MANAGE,
    ("GET", "/api/v1/users/{user_id}/scopes"): SCOPE_MANAGE,
    ("PUT", "/api/v1/users/{user_id}/scopes"): SCOPE_MANAGE,
    ("GET", "/api/v1/devices/{device_id}/scope"): SCOPE_MANAGE,
    ("PUT", "/api/v1/devices/{device_id}/scope"): SCOPE_MANAGE,
}
